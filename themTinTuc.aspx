<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="themTinTuc.aspx.cs" Inherits="qlNhanSu.themTinTuc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row mb-2">
        ...
        <div class="col-md-10">
            <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="luu" CssClass="btn btn-primary"/>
